...
public class StartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot questions : snapshot.child("WW1").getChildren()){
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(StartActivity.this, "Failed to get data from FireBase", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedOption != 0){
                    ...
                    Toast.makeText(StartActivity.this, "Please select an Option", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void finishQuiz(){
        ...
        Intent intent = new Intent(StartActivity.this, QuizResult.class);
